...
badd +36 app/controllers/p24_payments_controller.rb
badd +65 spec/controllers/p24_payments_controller_spec.rb
badd +127 config/routes.rb
badd +16 test/unit/blik/secure/transaction_creator_test.rb
badd +347 app/models/payment.rb
argglobal
%argdel
tabnew +setlocal\ bufhidden=wipe
tabrewind
edit spec/controllers/p24_payments_controller_spec.rb
...
silent! normal! zE
let &fdl = &fdl
let s:l = 65 - ((18 * winheight(0) + 19) / 38)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 198 - ((10 * winheight(0) + 19) / 38)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 198
...
silent! normal! zE
let &fdl = &fdl
let s:l = 485 - ((9 * winheight(0) + 10) / 20)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 485
