...
badd +46 app/services/kw_sales/bike_reservation_handler.rb
badd +61 app/helpers/offer_availability_helper.rb
...
silent! normal! zE
let &fdl = &fdl
let s:l = 66 - ((12 * winheight(0) + 9) / 18)
...
silent! normal! zE
let &fdl = &fdl
let s:l = 61 - ((18 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 61
...
silent! normal! zE
let &fdl = &fdl
let s:l = 71 - ((24 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 71
